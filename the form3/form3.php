...
<head>
    ...
    <label for="exampleInputEmail1" class="wow heartBeat" data-wow-duration="2s" data-wow-delay=".5s"><b>User name</b></label>
    <input type="text" class="form-control wow rubberBand" data-wow-duration="2s" data-wow-delay=".5s" id="exampleInputName1" placeholder="User_name" required>
  </div>
                
  <div class="form-group2">
    <label for="exampleInputEmail1" class="wow heartBeat" data-wow-duration="3s" data-wow-delay=".5s"><b>Email address</b></label>
    <input type="email" class="form-control wow rubberBand" data-wow-duration="3s" data-wow-delay=".5s" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="name@example.com" required>
  </div>
  <div class="form-group3">
      
      
    <label for="exampleInputPassword1" class="wow heartBeat" data-wow-duration="4s" data-wow-delay=".5s"><b>Phone number</b></label>
    <input type="tel" class="form-control wow rubberBand" data-wow-duration="4s" data-wow-delay=".5s" id="exampleInputPassword1" placeholder="+20" required>
  </div>
      <div class="form-group4">  
    <label for="exampleInputID1" class="wow heartBeat" data-wow-duration="4s" data-wow-delay=".5s"><b>National ID card</b></label>
    <input type="tel" class="form-control wow rubberBand" data-wow-duration="4s" data-wow-delay=".5s" id="exampleInputPassword1" placeholder="Your_ID" required>
  </div>
 
 <a href="#"> <button type="submit" class="btn btn-outline-secondary" onclick="alert('Okay! We will communicate with you to complete all data')">Confirm</button> </a>  
